...
(function(global) {
    ...
    var require = global.require = function(id) { /*debug*///console.log('require('+id+')');
        ...
        var file = new java.io.File("/Users/mark/Documents/modding/RebornComputers/src/main/resouces/assets/reborncomputers/operatingsystem/" + id);
        var moduleUri = file.toURI().toString();
        ...
        try {
            ...
            throw 'Unable to read file at: '+file.getAbsolutePath() +', '+e;
        }
